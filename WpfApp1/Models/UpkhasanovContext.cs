...
public partial class UpkhasanovContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        //=> optionsBuilder.UseSqlServer("Server=ARKESTRAT\\SQLEXPRESS;Database=UPKhasanov;TrustServerCertificate=True;Integrated Security=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Comment>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Comments)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Comments_Users1").OnDelete(DeleteBehavior.ClientSetNull);    
        });
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.HasOne(d => d.BuyerNavigation).WithMany(p => p.OrderBuyerNavigations)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Orders_Users").OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.SallerNavigation).WithMany(p => p.OrderSallerNavigations)
                .HasForeignKey(d => d.Saller)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Orders_Users1").OnDelete(DeleteBehavior.ClientSetNull);
        });
